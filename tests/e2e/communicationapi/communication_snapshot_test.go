...
// TestCommunicationAPIWithSnapshot tests communication API with snapshot functionality
func TestCommunicationAPIWithSnapshot(t *testing.T) {
	fmt.Println("🚀 Starting SaaSus Communication API Snapshot Tests")
	fmt.Println("===================================================")
	...
	engine := snapshot.NewE2EEngineWithSnapshot(client, GetCommunicationMethods(), config)
