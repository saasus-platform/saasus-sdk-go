...
// TestPricingAPIWithSnapshot tests pricing API with snapshot functionality
func TestPricingAPIWithSnapshot(t *testing.T) {
	fmt.Println("🚀 Starting SaaSus Pricing API Snapshot Tests")
	fmt.Println("==============================================")
	...
	client, err := pricing.PricingWithResponse()
	if err != nil {
	...
	engine := snapshot.NewE2EEngineWithSnapshot(client, GetPricingMethods(), config)
