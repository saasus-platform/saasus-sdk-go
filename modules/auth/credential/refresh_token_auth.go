...
// GetAuthCredentialsWithRefreshTokenAuth executes GetAuthCredentials API with refreshTokenAuth.
func GetAuthCredentialsWithRefreshTokenAuth(ctx context.Context, refreshToken string) (*authapi.Credentials, error) {
	if refreshToken == "" {
